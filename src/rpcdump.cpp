...
Value importprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"cccoinprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"cccoinprivkey\"   (string, required) The private key (see dumpprivkey)\n"
    ...
    //CKeyID vchAddress = pubkey.GetID();
    {
        ...
        pwalletMain->SetAddressBook(pubkey, strLabel, "receive");
...
Value importaddress(const Array& params, bool fHelp)
{
    ...
    if (address.IsValid()) {
        ...
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Cccoin address or script");
    }
...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"cccoinaddress\"   (string, required) The cccoin address for the private key\n"
            "\nResult:\n"
...
Value dumpwallet(const Array& params, bool fHelp)
{
    ...
    // produce output
    //file << strprintf("# Wallet dump created by Cccoin %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
