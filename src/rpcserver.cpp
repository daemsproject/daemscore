...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "blockchain",         "getfeerate",             &getfeerate,             true,      true,      false },
    { "blockchain",         "gettxout",               &gettxout,               true,      false,      false },
    { "blockchain",         "gettxoutsetinfo",        &gettxoutsetinfo,        true,      false,      false },
    { "blockchain",         "verifychain",            &verifychain,            true,      false,      false },
    { "blockchain",         "invalidateblock",        &invalidateblock,        true,      true,       false },
    { "blockchain",         "reconsiderblock",        &reconsiderblock,        true,      true,       false },
    { "blockchain",         "getcontentbylink",       &getcontentbylink,       true,      true,      false },
    { "blockchain",         "getcontentbystring",     &getcontentbystring,     true,      true,       false },
    { "blockchain",         "encodecontentunit",      &encodecontentunit,      true,      true,       false },
    { "blockchain",         "decodecontentunit",      &decodecontentunit,      true,      true,       false },
    { "blockchain",         "getlinkbytxidout",       &getlinkbytxidout,       true,      true,      false },
    { "blockchain",         "getlinktype",            &getlinktype,            true,      true,      false },
    { "blockchain",         "getcontents",            &getcontents,            true,      true,      false },
    { "blockchain",         "getcontentsbyaddresses", &getcontentsbyaddresses, true,      true,      false },
    { "blockchain",         "getpromotedcontents",    &getpromotedcontents,    true,      true,      false },
     { "blockchain",         "getsalesrecord",        &getsalesrecord,         true,      true,      false },
   { "blockchain",         "getpurchaserecord",       &getpurchaserecord,      true,      true,      false },
   
    { "blockchain",         "getfirstncc",            &getfirstncc,            true,      true,      false },
    { "blockchain",         "getmessages",            &getmessages,            true,      true,      false },
    { "blockchain",         "gettxmessages",          &gettxmessages,          true,      true,      false },
    { "blockchain",         "devtest",                &devtest,                true,      false,      false },
    { "blockchain",         "getdomaininfo",          &getdomaininfo,          true,      true,      false },
    { "blockchain",         "getdomainsbyowner",      &getdomainsbyowner,      true,      true,      false },
    { "blockchain",         "getdomainbyforward",     &getdomainbyforward,     true,      true,      false },
    { "blockchain",         "getdomainsbyforward",    &getdomainsbyforward,    true,      true,      false },
   { "blockchain",         "getdomainsbytags",        &getdomainsbytags,       true,      true,      false },
   { "blockchain",         "getdomainsbyalias",       &getdomainsbyalias,      true,      true,      false },
   { "blockchain",         "getdomainsexpiring",      &getdomainsexpiring,     true,      true,      false },
   
    { "blockchain",         "searchproducts",         &searchproducts,         true,      true,      false },
    { "blockchain",         "getproductbylink",       &getproductbylink,       true,      true,      false },
...
//    { "conf",               "setunfollow",            &setunfollow,            true,      true,       false },
    ...
    { "rawtransactions",    "decoderawtransaction",   &decoderawtransaction,   true,      false,      false },
     { "rawtransactions",    "encoderawtransaction",   &encoderawtransaction,   true,      true,      false },
    ...
    { "util",               "createcontent",          &createcontent,          true,      true ,      false },
    { "util",               "decodecontent",          &decodecontent,          true,      true ,      false },
    { "util",               "validateaddress",        &validateaddress,        true,      false,      false }, /* uses wallet if enabled */
    { "util",               "verifymessage",          &verifymessage,          true,      true,      false },
    ...
    { "util",               "getextpubkey",           &getextpubkey,           true,      true,       false },
    { "util",               "decodemultisigaddress",  &decodemultisigaddress,  true,      true,       false },
    ...
    { "wallet",             "getmainid",              &getmainid,              true,      true,      true },
    { "wallet",             "getaccount",             &getaccount,             true,      false,      true },
    { "wallet",             "getidlist",              &getidlist,              true,      true,      true },
    { "wallet",             "getbalance",             &getbalance,             false,     true,      true },
    { "wallet",             "getnewid",               &getnewid,               true,      true,      true },
    { "wallet",             "getidstep",              &getidstep,              true,      true,      true },
    { "wallet",             "getidbystep",            &getidbystep,            true,      true,      true },
   ...
   // { "wallet",             "listreceivedbyaddress",  &listreceivedbyaddress,  false,     false,      true },
    ...
    { "wallet",             "listtransactions2",       &listtransactions2,       false,     false,      true },
    { "wallet",             "listunspent",            &listunspent,            false,     false,      true },
   { "wallet",             "listunspent2",            &listunspent2,           false,     true,      true },
