...
CScript GetScriptForMultisigByWeight(int nRequired, const std::vector<CTxDestination>& dests, const std::vector<int>& weights) {
    CScript script;
    std::vector<unsigned char> sv = EncodeVarInt(nRequired);
