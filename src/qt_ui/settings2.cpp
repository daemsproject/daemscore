...
//#include <QtWebWidgets/QWebWidgets>
...
void SettingsDialog::loadDefaults()
{
    ...
    enableScrollAnimator->setChecked(defaultSettings->testAttribute(QWebSettings::ScrollAnimatorEnabled));
}
...
void SettingsDialog::loadFromSettings()
{
    ...
    const QString defaultHome = QLatin1String(BitcoinGUI::defaultHome);
...
void SettingsDialog::saveToSettings()
{
    ...
    BitcoinApplication::instance()->loadSettings();
#if defined(QWEBPAGE_SETNETWORKACCESSMANAGER)
    BitcoinGUI::networkAccessManager()->loadSettings();
    BitcoinGUI::cookieJar()->loadSettings();
#endif
    BitcoinGUI::historyManager()->loadSettings();
}
...
{
#if defined(QWEBPAGE_SETNETWORKACCESSMANAGER)
    CookiesExceptionsDialog *dialog = new CookiesExceptionsDialog(BitcoinGUI::cookieJar(), this);
    dialog->exec();
#endif
}
...
{
    BitcoinGUI *mw = static_cast<BitcoinGUI*>(parent());
