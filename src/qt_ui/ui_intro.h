...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to Fai Desktop Client.", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where Fai Desktop Client will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "Fai Desktop Client will download and store a copy of the Fai block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
